...
class Test_haff_1(unittest.TestCase):
    ...
    def test_huffman_encode_raises(self):
        self.assertRaises(TypeError, Haff.huffman_encode, 1)
        self.assertRaises(TypeError, Haff.huffman_encode, True)
        self.assertRaises(TypeError, Haff.huffman_encode, [234])
